...
if __name__ == '__main__':
    ...
    mp.spawn(train_nerf, nprocs=world_size, args=(world_size, epochs, learning_rate, save_epochs, batch_size, model_sel, object, output))

    # train_nerf(device=0, world_size=1, learning_rate=learning_rate, model_sel=model_sel, save_epochs=save_epochs, batch_size=batch_size, epochs=epochs, object=object, output_dir=output)
